...
CREATE TABLE `pedido` (
  ...
  KEY `pedido_banco_transferencia_id_foreign` (`banco_transferencia_id`),
  KEY `pedido_banco_pago_movil_id_foreign` (`banco_pago_movil_id`),
  KEY `idx_pedido_cliente_estado` (`cliente_id`,`estado`),
  CONSTRAINT `pedido_banco_pago_movil_id_foreign` FOREIGN KEY (`banco_pago_movil_id`) REFERENCES `banco` (`id`) ON DELETE SET NULL,
  CONSTRAINT `pedido_banco_transferencia_id_foreign` FOREIGN KEY (`banco_transferencia_id`) REFERENCES `banco` (`id`) ON DELETE SET NULL,
...
INSERT INTO `tipo_producto` VALUES (1,'Chemise','CHM','Camisas tipo polo con cuello','2025-12-16 17:48:48','2025-12-16 18:37:16',NULL),(2,'Franela','FRN','Franelas cuello redondo o V','2025-12-16 17:48:48','2025-12-16 17:48:48',NULL),(3,'Camisa','CAM','Camisas formales manga larga/corta','2025-12-16 17:48:48','2025-12-16 18:30:44',NULL),(4,'Pantalón','PNT','Pantalones de trabajo o formales','2025-12-16 17:48:48','2025-12-16 17:48:48',NULL),(5,'Chaqueta','CHQ','Chaquetas industriales o formales','2025-12-16 17:48:48','2025-12-16 17:48:48',NULL),(6,'Overol','OVR','Overoles y monos de trabajo','2025-12-16 17:48:48','2025-12-16 17:48:48',NULL),(7,'Uniforme Escolar','ESC','Prendas para uniformes escolares','2025-12-16 17:48:48','2025-12-16 17:48:48',NULL),(8,'Accesorio','ACC','Gorras, delantales, chalecos, etc.','2025-12-16 17:48:48','2025-12-16 17:48:48',NULL);
...
-- Dump completed on 2026-03-19 16:54:31
