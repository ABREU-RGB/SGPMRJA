                            ...
                            <div class="d-flex gap-2">
                                @if(Auth::user()->isAdmin())
                                    <button type="button" class="btn btn-success add-btn" data-bs-toggle="modal" id="create-btn"
                                        data-bs-target="#cotizacionSelectionModal">
                                                ...
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <div>
                                                        ...
                                                        <span class="fw-semibold"
                                                            id="view-referencia-transferencia">-</span>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-4" id="view-referencia-pago-movil-container"
                                                style="display:none;">
                                                <div class="d-flex align-items-center">
                                                    <div class="rounded-circle me-2 d-flex align-items-center justify-content-center"
                                                        style="width: 32px; height: 32px; background: rgba(0, 217, 165, 0.1);">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="mb-3">
                                                        <label for="cliente-telefono-field" class="form-label">Teléfono
                                                            Cliente</label>
                                                        <input type="text" id="cliente-telefono-field"
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="mb-2">
                                                <label class="form-label"><i
                                                        class="ri-bank-card-line align-bottom me-1"></i>
                                                    Método de Pago</label>
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="checkbox"
                                                        id="efectivo-pagado-field" name="efectivo_pagado" value="1">
                                                    <label class="form-check-label"
                                                        for="efectivo-pagado-field">Efectivo</label>
                                                </div>
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="checkbox"
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6">
                                                        ...
                                                        <select id="banco-transferencia-id-field"
                                                            name="banco_transferencia_id" class="form-control">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="mb-3">
                                        <label for="documento-field-cliente" class="form-label">Documento (Cédula o
                                            RIF)</label>
                                        <input type="text" id="documento-field-cliente" name="documento"
                                            class="form-control" placeholder="Cédula o RIF" required />
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        <label for="direccion-field-cliente" class="form-label">Dirección</label>
                                        <input type="text" id="direccion-field-cliente" name="direccion"
                                ...
                                $('#showModal').one('shown.bs.modal', function () {
                                    Swal.fire({
                                        ...
                                        didOpen: function (toast) {
                                            // Mover el container del Toast directamente al body
                                            // para escapar los stacking contexts del layout (transform/position)
                                            var container = toast.parentElement;
                                            if (container && container.parentElement !== document.body) {
                                                document.body.appendChild(container);
                                            }
                                            // Forzar z-index superior al modal de Bootstrap
